        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            ...
            @elseif(Session::get('login') == TRUE)
                ...
                <div class="navbar-nav">
                    <div class="nav-item">
                        <a class="nav-link" href="/beranda-admin">{{ Session::get('nama') }} [ {{ Session::get('role') }} ]</a>
                    </div>
                </div>
                @else
                <div class="navbar-nav">
                    <div class="nav-item">
                        <a class="nav-link" href="/profile/{{ Session::get('id') }}">
                            {{ Session::get('nama') }}
                            @if(Session::get('foto_profile'))
                                <img class="rounded-circle" src="/images/foto_profile/{{ Session::get('foto_profile') }}" width="30px">
                            @else
