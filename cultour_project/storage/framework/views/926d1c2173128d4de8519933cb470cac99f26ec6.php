<?php $__env->startSection('title', 'Registrasi Wisatawan'); ?>
...
<div class='row no-gutters justify-content-center'>
        ...
        <div class='card col-6'>
            ...
            <h3 class='card-header text-center'>REGISTRASI WISATAWAN</h3>

            <form action="/register/wisatawan/store" method="post">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <!--title-->
                                    <h5 class="modal-title" id="modalDayaLabel">Registrawi Wisatawan</h5>
                                    <!--tombol x-->
                                ...
                                <div class="modal-body">
                                    <p class="text-center">Registrasi sebagai wisatawan?</p>
                                </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\library data koding\Anti-Mager_Project\cultour_project\resources\views/akun/register_wisatawan.blade.php ENDPATH**/ ?>